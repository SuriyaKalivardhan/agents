...
customersubnetname=suriyak0customer3-aca-subnet2
...
commonHoBoResourcegroup=$(cut -d'/' -f5 <<<$customeracasubnetid)-chobov3
acaenvname=$(cut -d'/' -f5 <<<$customeracasubnetid)-acaenv-2
